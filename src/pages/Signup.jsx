...
const Signup = () => {
    ...
    return (
        <div style={{
            ...
            background: 'radial-gradient(circle at bottom left, var(--color-bg-tertiary) 0%, var(--color-bg-primary) 100%)',
            padding: '1rem'
        }}>
            <div className="glass-panel" style={{
                ...
                <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
                    ...
                    <p style={{ color: 'var(--color-text-muted)' }}>Join EaseNotes today</p>
                </div>
